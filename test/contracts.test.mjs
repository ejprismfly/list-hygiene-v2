...
test("auth pages follow the shadcn login-02 two-column composition", () => {
  ...
  assert.match(authLayout, /relative hidden bg-muted lg:block/)
  assert.match(authLayout, /src="\/auth-cover\.svg"/)
  assert.match(authLayout, /object-cover dark:brightness-\[0\.2\] dark:grayscale/)
